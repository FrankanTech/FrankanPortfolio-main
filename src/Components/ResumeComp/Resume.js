...
export default class Resume extends Component {
    ...
    render() {
        return (
            ...
            Skills = 
            { 
                [{Title:"Asp.Net", List:["Integrating third-party Payment options. Updating current integrated payment options.", 
            ...
            {Title:"React", List:["Upgrading the front end of project that use older front end technologies to a newer and up to date technology such as react and angular.", 
            ...
            {Title:"CSS", List:["Implementing new design for web page using Bootstrap and custom CSS code.", 
            "Using SCSS for variable implementation code, such as Dark and Light mode."
        ]},
        {Title:"SQL", List:["Creating new Tables for the database.", 
        "CRUD implementation on current implemented tables."
            ...
            Skills = 
            { 
                [{Title:"Asp.Net", List:["Using .NET framework to develop Web applications. This varies to Webservices using REST to MVC applications.", 
            ...
            {Title:"C#", List:["Using C# to develop console application with a daily timer that performs a task daily. Such as archiving, cleaning and creating items within a site..", 
            "Using C# to develop SharePoint related projects which kick starts workflows from a Console/Desktop application."]},

            {Title:"Python", List:["Developing scraping tools that is used to read contents of a web page and stores the data in excel.", 
            "Using Flask to develop various functionalities while having a UI for the front user."]},

            {Title:"SQL", List:["SQL database handling, cleaning or editing data. Backing up and restoring databases. Creating, updating or deleting databases."
            ]},

            {Title:"SharePoint", List:["Testing and documenting internal and client SharePoint sites, including workflows and other site functionalities.", 
            ...
            {Title:"Other", List:["Installing and testing server patching.", 
